...
export class PlanService {
  ...
  private getSamplePlan(): Plan {
    ...
    p.schedules[0].rows.push((() => {
      ...
      row.url = 'https://www.google.com/maps/place/%E6%96%B0%E5%A4%A7%E9%98%AA%E9%A7%85/@34.7334658,135.5002547,15z/data=!4m5!3m4!1s0x0:0x3bd7c4e0bf1076cf!8m2!3d34.7334658!4d135.5002547';
      return row;
    })());
    p.schedules[0].rows.push((() => {
      const row = new ScheduleRowMoving();
      ...
      row.url = 'https://transit.yahoo.co.jp/search/result?flatlon=&from=%E6%96%B0%E5%A4%A7%E9%98%AA&tlatlon=&to=USJ&viacode=&via=&viacode=&via=&viacode=&via=&y=2019&m=02&d=21&hh=09&m2=3&m1=0&type=1&ticket=ic&expkind=1&ws=3&s=0&al=1&shin=1&ex=1&hb=1&lb=1&sr=1&kw=USJ';
      return row;
    })());
    p.schedules[0].rows.push((() => {
      const row = new ScheduleRowPlace();
      ...
      row.url = 'https://www.google.com/maps/place/%E3%83%A6%E3%83%8B%E3%83%90%E3%83%BC%E3%82%B5%E3%83%AB%E3%82%B7%E3%83%86%E3%82%A3%E9%A7%85/@34.6678432,135.4363651,17z/data=!3m1!4b1!4m5!3m4!1s0x6000e890dcaf65db:0x44b3a88239419885!8m2!3d34.6678388!4d135.4385538';
      return row;
    })());
